...
<form action="{{route('switch.buscar')}}" method="post" class="form form-inline">
    @csrf
...
<div class="card">
    <div class="card-header">
        <h1><a href="{{route('switch.create')}}" class="btn btn-outline-primary">Cadastrar</a></h1>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="10%">
                        ...
                        <a href="{{route('switch.edit',$switchs->tombo)}}" class="btn btn-outline-warning btn-lg"><i class="fas fa-pen"></i></a>
                    </td>
                    <td>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            {{---Formulario delete ---}}
            <form action="{{route('switch.destroy',$switchs->tombo)}}" method="post">
                @csrf
                @method('DELETE')

            <div class="modal-body">
                <i><b>Tombo:</b> {{$switchs->tombo}}</i><br>
              <i><b>N° de Serie:</b> {{$switchs->n_s}}</i><br>
            </div>
    ...
    <div class="card-footer">
        {{ $switch->links()}}
        <a href="{{route('switch.pdf')}}" target="_blank" class="btn btn-outline-danger ">Relatório PDF</a>
