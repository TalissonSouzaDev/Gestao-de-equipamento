...
<form action="{{route('teclado.buscar')}}" method="post" class="form form-inline">
    @csrf
...
<div class="card">
    <div class="card-header">
        <h1><a href="{{route('teclado.create')}}" class="btn btn-outline-primary">Cadastrar</a></h1>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="10%">
                        ...
                        <a href="{{route('teclado.edit',$teclados->n_s)}}" class="btn btn-outline-warning btn-lg"><i class="fas fa-pen"></i></a>
                    </td>
                    <td>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            {{---Formulario delete ---}}
            <form action="{{route('teclado.destroy',$teclados->n_s)}}" method="post">
                @csrf
                @method('DELETE')

            <div class="modal-body">
              <i><b>N° de Serie:</b> {{$teclados->n_s}}</i>
            </div>
    ...
    <div class="card-footer">
        {{ $teclado->links() }}
        <a href="{{route('teclado.pdf')}}" target="_blank" class="btn btn-outline-danger ">Relatório PDF</a>
