...
class validarmultimetro extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'tombo'=>"required|min:3|max:50|unique:multimetros,tombo,{$url},n_s",
            'n_s'=>"required|min:3|max:50|unique:multimetros,n_s,{$url},n_s",
