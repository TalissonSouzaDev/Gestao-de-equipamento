...
class validarswitche extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'tombo'=>"required|min:3|max:50|unique:switchs,tombo,{$url},tombo",
            'n_s'=>"required|min:3|max:50|unique:switchs,n_s,{$url},tombo",
