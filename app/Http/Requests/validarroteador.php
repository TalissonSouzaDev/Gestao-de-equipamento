...
class validarroteador extends FormRequest
{
    /**
    ...
    $url = $this->segment(4);
       return [
        'equipamento'=>'required|min:3|max:50',
           ...
           'tombo'=>"required|min:3|max:50|unique:roteadors,tombo,{$url},tombo",
           'n_s'=>"required|min:3|max:50|unique:roteadors,n_s,{$url},tombo",
