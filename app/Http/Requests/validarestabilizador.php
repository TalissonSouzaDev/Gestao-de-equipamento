...
class validarestabilizador extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'tombo'=>"required|min:3|max:50|unique:estabilizadors,tombo,{$url},n_s",
            'n_s'=>"required|min:3|max:50|unique:estabilizadors,n_s,{$url},n_s",
