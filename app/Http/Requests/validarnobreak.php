...
class validarnobreak extends FormRequest
{
    /**
    ...
    $url = $this->segment(4);
       return [
        'equipamento'=>'required|min:3|max:50',
           'tombo'=>"required|min:3|max:50|unique:nobreaks,tombo,{$url},n_s",
           'n_s'=>"required|min:3|max:50|unique:nobreaks,n_s,{$url},n_s",
       ...
       public function messages()
       {
           return [
               ...
               'tombo.unique'=>'Ja Existe Cadastrado com esse tombo',
