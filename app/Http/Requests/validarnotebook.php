...
class validarnotebook extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        'nome'=>"required|min:3|max:50|unique:notebooks,nome,{$url},tombo",
        'tombo'=>"required|min:3|max:50|unique:notebooks,tombo,{$url},tombo",
        'n_s'=>"required|min:3|max:50|unique:notebooks,n_s,{$url},tombo",
