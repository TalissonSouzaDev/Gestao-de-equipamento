...
class validartelefone extends FormRequest
{
    /**
    ...
    $url = $this->segment(4);
       return [
        'equipamento'=>'required|min:3|max:50',
           ...
           'tombo'=>"required|min:3|max:50|unique:telefones,tombo,{$url},n_s",
           'n_s'=>"required|min:3|max:50|unique:telefones,n_s,{$url},n_s",
